...
This happens because the part-of-speech ''verb`` is more likely to follow a proper noun according to our transition matrix, and thus ''has`` and ''owns``, who are both verbs become even more likely to follow a proper noun. 
This method can then be further applied to a bigram, a trigram or any n-grams that follows. 
...
% Jag tror att vi bör lägga till en motivering här om varför vi kollar efter unikheten i tweetsen. Det är ju ett par steg bort, vi ville generera tweets åt CB ->
% tweetsen ska se bra ut -> tweetsen får däremot inte vara direkt kopierade från korpus för det är typ fusk. Vi behöver förtydliga den kedjan tror jag :) /Nisse
...
% ta upp failure rate (2 per 10000), bara constrained kan missa
