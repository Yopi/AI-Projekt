...
\label{sec:intro}'
\textbf{What is the problem and why is it important? \\ What will the reader get out of it? \\ Present specific results \\ Don't go into detail \\ }\\\\
...
\label{sec:relwork}
\textbf{It is here we show that we know the field well and present the reports that we have read}\\\\
...
\begin{figure}[h!]
  \hfill
  \subfigure[Unigram of the limited corpus]{\includegraphics[width=0.49\linewidth]{Bigram.png}}
  \hfill
  \subfigure[Unigram with constraints applied]{\includegraphics[width=0.49\linewidth]{Bigram2.png}}
  \hfill
  \caption{Unigrams}
 \end{figure}
